...
pub fn from_byte(byte: u8) -> Box<Instruction> {
    match byte {
        ...
        0xF2 => Box::new(pai(ld::ld_a_mem_at_c)),
...
pub fn from_prefixed_byte(byte: u8) -> Box<Instruction> {
    match byte {
        ...
        0x80 => Box::new(dpai(bit::res_r(RegisterTarget::B, 0))),
        0x81 => Box::new(dpai(bit::res_r(RegisterTarget::C, 0))),
        0x82 => Box::new(dpai(bit::res_r(RegisterTarget::D, 0))),
        0x83 => Box::new(dpai(bit::res_r(RegisterTarget::E, 0))),
        0x84 => Box::new(dpai(bit::res_r(RegisterTarget::H, 0))),
        0x85 => Box::new(dpai(bit::res_r(RegisterTarget::L, 0))),
        0x86 => Box::new(dpai(bit::res_mem_at_hl(0))),
        0x87 => Box::new(dpai(bit::res_r(RegisterTarget::A, 0))),
        0x88 => Box::new(dpai(bit::res_r(RegisterTarget::B, 1))),
        0x89 => Box::new(dpai(bit::res_r(RegisterTarget::C, 1))),
        0x8A => Box::new(dpai(bit::res_r(RegisterTarget::D, 1))),
        0x8B => Box::new(dpai(bit::res_r(RegisterTarget::E, 1))),
        0x8C => Box::new(dpai(bit::res_r(RegisterTarget::H, 1))),
        0x8D => Box::new(dpai(bit::res_r(RegisterTarget::L, 1))),
        0x8E => Box::new(dpai(bit::res_mem_at_hl(1))),
        0x8F => Box::new(dpai(bit::res_r(RegisterTarget::A, 1))),
        0x90 => Box::new(dpai(bit::res_r(RegisterTarget::B, 2))),
        0x91 => Box::new(dpai(bit::res_r(RegisterTarget::C, 2))),
        0x92 => Box::new(dpai(bit::res_r(RegisterTarget::D, 2))),
        0x93 => Box::new(dpai(bit::res_r(RegisterTarget::E, 2))),
        0x94 => Box::new(dpai(bit::res_r(RegisterTarget::H, 2))),
        0x95 => Box::new(dpai(bit::res_r(RegisterTarget::L, 2))),
        0x96 => Box::new(dpai(bit::res_mem_at_hl(2))),
        0x97 => Box::new(dpai(bit::res_r(RegisterTarget::A, 2))),
        0x98 => Box::new(dpai(bit::res_r(RegisterTarget::B, 3))),
        0x99 => Box::new(dpai(bit::res_r(RegisterTarget::C, 3))),
        0x9A => Box::new(dpai(bit::res_r(RegisterTarget::D, 3))),
        0x9B => Box::new(dpai(bit::res_r(RegisterTarget::E, 3))),
        0x9C => Box::new(dpai(bit::res_r(RegisterTarget::H, 3))),
        0x9D => Box::new(dpai(bit::res_r(RegisterTarget::L, 3))),
        0x9E => Box::new(dpai(bit::res_mem_at_hl(3))),
        0x9F => Box::new(dpai(bit::res_r(RegisterTarget::A, 3))),
        0xA0 => Box::new(dpai(bit::res_r(RegisterTarget::B, 4))),
        0xA1 => Box::new(dpai(bit::res_r(RegisterTarget::C, 4))),
        0xA2 => Box::new(dpai(bit::res_r(RegisterTarget::D, 4))),
        0xA3 => Box::new(dpai(bit::res_r(RegisterTarget::E, 4))),
        0xA4 => Box::new(dpai(bit::res_r(RegisterTarget::H, 4))),
        0xA5 => Box::new(dpai(bit::res_r(RegisterTarget::L, 4))),
        0xA6 => Box::new(dpai(bit::res_mem_at_hl(4))),
        0xA7 => Box::new(dpai(bit::res_r(RegisterTarget::A, 4))),
        0xA8 => Box::new(dpai(bit::res_r(RegisterTarget::B, 5))),
        0xA9 => Box::new(dpai(bit::res_r(RegisterTarget::C, 5))),
        0xAA => Box::new(dpai(bit::res_r(RegisterTarget::D, 5))),
        0xAB => Box::new(dpai(bit::res_r(RegisterTarget::E, 5))),
        0xAC => Box::new(dpai(bit::res_r(RegisterTarget::H, 5))),
        0xAD => Box::new(dpai(bit::res_r(RegisterTarget::L, 5))),
        0xAE => Box::new(dpai(bit::res_mem_at_hl(5))),
        0xAF => Box::new(dpai(bit::res_r(RegisterTarget::A, 5))),
        0xB0 => Box::new(dpai(bit::res_r(RegisterTarget::B, 6))),
        0xB1 => Box::new(dpai(bit::res_r(RegisterTarget::C, 6))),
        0xB2 => Box::new(dpai(bit::res_r(RegisterTarget::D, 6))),
        0xB3 => Box::new(dpai(bit::res_r(RegisterTarget::E, 6))),
        0xB4 => Box::new(dpai(bit::res_r(RegisterTarget::H, 6))),
        0xB5 => Box::new(dpai(bit::res_r(RegisterTarget::L, 6))),
        0xB6 => Box::new(dpai(bit::res_mem_at_hl(6))),
        0xB7 => Box::new(dpai(bit::res_r(RegisterTarget::A, 6))),
        0xB8 => Box::new(dpai(bit::res_r(RegisterTarget::B, 7))),
        0xB9 => Box::new(dpai(bit::res_r(RegisterTarget::C, 7))),
        0xBA => Box::new(dpai(bit::res_r(RegisterTarget::D, 7))),
        0xBB => Box::new(dpai(bit::res_r(RegisterTarget::E, 7))),
        0xBC => Box::new(dpai(bit::res_r(RegisterTarget::H, 7))),
        0xBD => Box::new(dpai(bit::res_r(RegisterTarget::L, 7))),
        0xBE => Box::new(dpai(bit::res_mem_at_hl(7))),
        0xBF => Box::new(dpai(bit::res_r(RegisterTarget::A, 7))),
