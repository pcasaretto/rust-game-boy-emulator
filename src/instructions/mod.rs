...
pub fn from_byte(byte: u8) -> Box<Instruction> {
    match byte {
        ...
        0x78 => Box::new(ld::ld_r_r(RegisterTarget::B, RegisterTarget::A)),
        0x79 => Box::new(ld::ld_r_r(RegisterTarget::C, RegisterTarget::A)),
        0x7A => Box::new(ld::ld_r_r(RegisterTarget::D, RegisterTarget::A)),
        0x7B => Box::new(ld::ld_r_r(RegisterTarget::D, RegisterTarget::A)),
        0x7C => Box::new(ld::ld_r_r(RegisterTarget::H, RegisterTarget::A)),
        0x7D => Box::new(ld::ld_r_r(RegisterTarget::L, RegisterTarget::A)),
...
pub fn from_prefixed_byte(byte: u8) -> Box<Instruction> {
    match byte {
        ...
        0x42 => Box::new(bit::bit_r(RegisterTarget::D, 0)),
        0x43 => Box::new(bit::bit_r(RegisterTarget::E, 0)),
        0x44 => Box::new(bit::bit_r(RegisterTarget::H, 0)),
        0x45 => Box::new(bit::bit_r(RegisterTarget::L, 0)),
        0x46 => Box::new(bit::bit_mem_at_hl(0)),
        0x47 => Box::new(bit::bit_r(RegisterTarget::A, 0)),
        0x48 => Box::new(bit::bit_r(RegisterTarget::B, 1)),
        0x49 => Box::new(bit::bit_r(RegisterTarget::C, 1)),
        0x4A => Box::new(bit::bit_r(RegisterTarget::D, 1)),
        0x4B => Box::new(bit::bit_r(RegisterTarget::E, 1)),
        0x4C => Box::new(bit::bit_r(RegisterTarget::H, 1)),
        0x4D => Box::new(bit::bit_r(RegisterTarget::L, 1)),
        0x4E => Box::new(bit::bit_mem_at_hl(1)),
        0x4F => Box::new(bit::bit_r(RegisterTarget::A, 1)),
        0x50 => Box::new(bit::bit_r(RegisterTarget::B, 2)),
        0x51 => Box::new(bit::bit_r(RegisterTarget::C, 2)),
        0x52 => Box::new(bit::bit_r(RegisterTarget::D, 2)),
        0x53 => Box::new(bit::bit_r(RegisterTarget::E, 2)),
        0x54 => Box::new(bit::bit_r(RegisterTarget::H, 2)),
        0x55 => Box::new(bit::bit_r(RegisterTarget::L, 2)),
        0x56 => Box::new(bit::bit_mem_at_hl(2)),
        0x57 => Box::new(bit::bit_r(RegisterTarget::A, 2)),
        0x58 => Box::new(bit::bit_r(RegisterTarget::B, 3)),
        0x59 => Box::new(bit::bit_r(RegisterTarget::C, 3)),
        0x5A => Box::new(bit::bit_r(RegisterTarget::D, 3)),
        0x5B => Box::new(bit::bit_r(RegisterTarget::E, 3)),
        0x5C => Box::new(bit::bit_r(RegisterTarget::H, 3)),
        0x5D => Box::new(bit::bit_r(RegisterTarget::L, 3)),
        0x5E => Box::new(bit::bit_mem_at_hl(3)),
        0x5F => Box::new(bit::bit_r(RegisterTarget::A, 3)),
        0x60 => Box::new(bit::bit_r(RegisterTarget::B, 4)),
        0x61 => Box::new(bit::bit_r(RegisterTarget::C, 4)),
        0x62 => Box::new(bit::bit_r(RegisterTarget::D, 4)),
        0x63 => Box::new(bit::bit_r(RegisterTarget::E, 4)),
        0x64 => Box::new(bit::bit_r(RegisterTarget::H, 4)),
        0x65 => Box::new(bit::bit_r(RegisterTarget::L, 4)),
        0x66 => Box::new(bit::bit_mem_at_hl(4)),
        0x67 => Box::new(bit::bit_r(RegisterTarget::A, 4)),
        0x68 => Box::new(bit::bit_r(RegisterTarget::B, 5)),
        0x69 => Box::new(bit::bit_r(RegisterTarget::C, 5)),
        0x6A => Box::new(bit::bit_r(RegisterTarget::D, 5)),
        0x6B => Box::new(bit::bit_r(RegisterTarget::E, 5)),
        0x6C => Box::new(bit::bit_r(RegisterTarget::H, 5)),
        0x6D => Box::new(bit::bit_r(RegisterTarget::L, 5)),
        0x6E => Box::new(bit::bit_mem_at_hl(5)),
        0x6F => Box::new(bit::bit_r(RegisterTarget::A, 5)),
        0x70 => Box::new(bit::bit_r(RegisterTarget::B, 6)),
        0x71 => Box::new(bit::bit_r(RegisterTarget::C, 6)),
        0x72 => Box::new(bit::bit_r(RegisterTarget::D, 6)),
        0x73 => Box::new(bit::bit_r(RegisterTarget::E, 6)),
        0x74 => Box::new(bit::bit_r(RegisterTarget::H, 6)),
        0x75 => Box::new(bit::bit_r(RegisterTarget::L, 6)),
        0x76 => Box::new(bit::bit_mem_at_hl(6)),
        0x77 => Box::new(bit::bit_r(RegisterTarget::A, 6)),
        0x78 => Box::new(bit::bit_r(RegisterTarget::B, 7)),
        0x79 => Box::new(bit::bit_r(RegisterTarget::C, 7)),
        0x7A => Box::new(bit::bit_r(RegisterTarget::D, 7)),
        0x7B => Box::new(bit::bit_r(RegisterTarget::E, 7)),
        0x7C => Box::new(bit::bit_r(RegisterTarget::H, 7)),
        0x7D => Box::new(bit::bit_r(RegisterTarget::L, 7)),
        0x7E => Box::new(bit::bit_mem_at_hl(7)),
        0x7F => Box::new(bit::bit_r(RegisterTarget::A, 7)),
